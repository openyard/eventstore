...
import (
	...
	"github.com/openyard/eventstore/pkg/kvstore"

	"google.golang.org/grpc"
	"google.golang.org/grpc/reflection"
)

var buckets = []string{domain.KvsBucketIndex, domain.KvsBucketContent}

func main() {
	s := domain.NewService(domain.WithKeyValueStore(kvstore.NewMemoryKVS(buckets...)))
